...
// ==== Challenge 3 ==== model names into alphabetical order and log the results in the console
let carModels = []
for (i in inventory){
  carModels.push(inventory[i].car_model)
}

// The marketing team wants the car models listed alphabetically on the website. Sort all the car
